...
В ответ на такой запрос Вы получите один из трех следующих ответов: 
```
1) "The game is on"
...
С полной версией можно ознакомиться [здесь](https://github.com/FadeevSergey/WEB_CHEES_API/blob/master/src/data/gameState.json)
